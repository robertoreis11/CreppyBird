...
IMAGEM_CANO = pygame.transform.scale2x(pygame.image.load(os.path.join('CreppyBird', 'imgs', 'pipe.png')))
IMAGEM_CHAO = pygame.transform.scale2x(pygame.image.load(os.path.join('CreppyBird', 'imgs', 'base.jpg')))
IMAGEM_BACKGROUND_ORIGINAL = pygame.image.load(os.path.join('CreppyBird', 'imgs', 'background_cemiterio.png'))

#Alteração grupo 3
pygame.mixer.init()
musica_de_fundo = pygame.mixer.music.load(os.path.join('CreppyBird','sons', 'this-is-halloween-172354.mp3'))
pygame.mixer.music.set_volume(0.5)
som_contagem = pygame.mixer.Sound(os.path.join('CreppyBird','sons','smw_kick.wav'))
som_pulo = pygame.mixer.Sound(os.path.join('CreppyBird','sons', 'mixkit-player-jumping-in-a-video-game-2043.wav'))
som_colisão = pygame.mixer.Sound(os.path.join('CreppyBird','sons','mixkit-arcade-fast-game-over-233.wav'))
...
def load_gif(filename):
    ...
    return frames
IMAGENS_CORVO = load_gif(os.path.join('CreppyBird','imgs', 'crow.gif'))
